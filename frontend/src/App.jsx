...
const CHECKLIST_TOPICS = {
  ...
  RESUME: [
    { id: 'resume-contact-information', label: 'Contact Information' },
    { id: 'resume-professional-summary', label: 'Professional Summary / Career Objective' },
    { id: 'resume-education', label: 'Educational Qualifications' },
    { id: 'resume-technical-skills', label: 'Technical Skills' },
    { id: 'resume-work-experience', label: 'Work Experience / Internships' },
    { id: 'resume-projects', label: 'Projects' },
    { id: 'resume-certifications', label: 'Certifications' },
    { id: 'resume-achievements-awards', label: 'Achievements & Awards' },
    { id: 'resume-extracurricular-leadership', label: 'Extra-Curricular Activities / Leadership' },
    { id: 'resume-languages-interests', label: 'Languages & Interests' },
  ],
}
